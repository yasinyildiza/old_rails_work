module ApplicationHelper
  ...
  def tbody_for_team_member(data)
    content_tag(:tbody) do
      if data.first.class.model_name == "Trainer"
        render :partial => "teams/trainer_member", :collection => data,:as => :trainer
      else
        render :partial => "teams/parent_member", :collection => data,:as => :parent
      end
    end
  end
